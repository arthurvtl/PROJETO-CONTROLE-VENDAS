...
public class ProdutoDao
{
     public static void salvar(Produto produto) 
        ...
        String sql = "INSERT INTO estoque_controle.TBPRODUTOS(nome, categoria, "
    ...
    public static List<Produto> listar()
        ...
        String sql = "SELECT id, nome, categoria, quantidade, custo, valor, descricao  "
                + "FROM estoque_controle.TBPRODUTOS";
    ...
    public static List<Produto> procurar(String nome)
        ...
        String sql = "SELECT id, nome, categoria, quantidade, custo, valor, descricao  "
                + "FROM estoque_controle.TBPRODUTOS WHERE nome LIKE (?)";
        List<Produto> listaProdutos = null;
    ...
    public static Produto obter(Integer id) 
        ...
        String sql = "SELECT * FROM estoque_controle.TBPRODUTOS WHERE id =?";
    ...
    public static void atualizar(Produto produtoAtualizado) 
        ...
        String sql = "UPDATE estoque_controle.TBPRODUTOS SET nome = ?, "
    ...
    public static void excluir(Integer id)
        throws SQLException, Exception {
        String sql = "DELETE FROM estoque_controle.TBPRODUTOS WHERE id = ?";        
