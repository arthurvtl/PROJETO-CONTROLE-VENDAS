...
public class ClienteDao
{
     public static void salvar(Cliente cliente) 
        ...
        String sql = "INSERT INTO estoque_controle.TBCLIENTES(nome, cpf, "
    ...
    public static List<Cliente> listar()
        ...
        String sql = "SELECT  id, nome, cpf, sexo, estadoCivil, dataNascimento, "
                ...
                + "FROM estoque_controle.TBCLIENTES";
    ...
    public static List<Cliente> procurar(String nome)
        ...
        String sql = "SELECT  id, nome, cpf, sexo, estadoCivil, dataNascimento, "
                + "estado, cidade, bairro, logradouro, numero, email, "
                + "telefoneCelular, telefoneOutros, observacoes "
                + "FROM estoque_controle.TBCLIENTES WHERE nome LIKE (?)";
        List<Cliente> listaClientes = null;
    ...
    public static Cliente obter(Integer id) 
        ...
        String sql = "SELECT * FROM estoque_controle.TBCLIENTES WHERE id =?";
    ...
    public static Cliente obter2(String cpf) 
        ...
        String sql = "SELECT * FROM estoque_controle.TBCLIENTES WHERE cpf =?";
    ...
    public static void atualizar(Cliente clienteAtualizado) 
        ...
        String sql = "UPDATE estoque_controle.TBCLIENTES SET nome = ?, cpf = ?, "
    ...
    public static void excluir(Integer id)
        throws SQLException, Exception {
        String sql = "DELETE FROM estoque_controle.TBCLIENTES WHERE id = ?";        
